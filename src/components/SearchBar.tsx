  ...
  return (
    <div className="flex flex-col items-center">
      <div className="flex justify-between lg:my-16 sm:my-8 border-2 border-violet-600 w-[80%] items-center lg:p-7 sm:p-4 rounded-[5rem]">
        <input type="text" onChange={(e)=> setSearch(e.target.value)} className="outline-none lg:text-3xl sm:text-sm sm:p-3 rounded-3xl w-full" placeholder="Search What You Want ..." />
